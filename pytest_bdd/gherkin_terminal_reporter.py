    ...
    def pytest_runtest_logreport(self, report):
        ...
        if self.verbosity <= 0:
            ...
            if hasattr(report, 'scenario'):
                ...
                #self._tw.write('    Cenário: ', **scenario_markup)
                #self._tw.write(f'    {STEP_PREFIXES_BY_TYPE[SCENARIO]}: ', **scenario_markup)
            ...
            if hasattr(report, 'scenario'):
                ...
                #self._tw.write('    Scenario: ', **scenario_markup)
                #self._tw.write('    Cenário: ', **scenario_markup)
                #self._tw.write('    {}: '.format(feature.prefix_by_type(types.SCENARIO)), **scenario_markup)
                self._tw.write(scenario_label, **scenario_markup)
                self._tw.write(report.scenario['name'], **scenario_markup)
                self._tw.write('\n')
