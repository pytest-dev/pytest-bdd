...
def test_step_trace(testdir):
    ...
    expected = {'feature': {'description': u'',
                ...
                'steps': [{'duration': equals_any(float),
                           ...
                           'keyword': 'Given',
                           'line_number': 15,
                           'name': u'there are 12 cucumbers',
                           'type': 'given'},
                          {'duration': equals_any(float),
                           'failed': False,
                           'keyword': 'When',
                           'line_number': 16,
                           'name': u'I eat 5.0 cucumbers',
                           'type': 'when'},
                          {'duration': equals_any(float),
                           'failed': False,
                           'keyword': 'Then',
                           'line_number': 17,
                           'name': u'I should have 7 cucumbers',
                           'type': 'then'}],
                'tags': [],
    ...
    expected = {'feature': {'description': u'',
                ...
                'steps': [{'duration': equals_any(float),
                           ...
                           'keyword': 'Given',
                           'line_number': 15,
                           'name': u'there are 5 cucumbers',
                           'type': 'given'},
                          {'duration': equals_any(float),
                           'failed': False,
                           'keyword': 'When',
                           'line_number': 16,
                           'name': u'I eat 4.0 cucumbers',
                           'type': 'when'},
                          {'duration': equals_any(float),
                           'failed': False,
                           'keyword': 'Then',
                           'line_number': 17,
                           'name': u'I should have 1 cucumbers',
                           'type': 'then'}],
                'tags': [],
                'examples': [{'line_number': 19,
                              'name': None,
