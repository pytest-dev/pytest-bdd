...
def test_tags(request):
    ...
    assert getattr(test, 'pytestbdd-tag-scenario-tag-1')
    assert getattr(test, 'pytestbdd-tag-scenario-tag-2')

    assert getattr(test, 'pytestbdd-tag-feature-tag-1')
    assert getattr(test, 'pytestbdd-tag-feature-tag-2')
