...
def test_generate(testdir: Testdir, monkeypatch: MonkeyPatch, capsys: CaptureFixture) -> None:
...
def test_generate_with_quotes(testdir: Testdir) -> None:
...
def test_unicode_characters(testdir: Testdir, monkeypatch: MonkeyPatch) -> None:
